# ifndef __OPERATOR_SUBTRACTION_H
# define __OPERATOR_SUBTRACTION_H
...
/*!
 * \file
 * \brief Operator \c - (binary): replace the two \c value's on top of the stack by their difference.
 *
